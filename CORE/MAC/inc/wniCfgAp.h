...
#define WNI_CFG_BTC_ACTIVE_WLAN_LEN    298
#define WNI_CFG_BTC_ACTIVE_BT_LEN    299
#define WNI_CFG_BTC_SAP_ACTIVE_WLAN_LEN    300
#define WNI_CFG_BTC_SAP_ACTIVE_BT_LEN    301
