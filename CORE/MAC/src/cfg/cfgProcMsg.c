...
tAniSirCgStatic cfgStatic[CFG_PARAM_MAX_NUM] =
{
    ...
    {WNI_CFG_ENABLE_RTSCTS_HTVHT,
     ...
     WNI_CFG_ENABLE_RTSCTS_HTVHT_STAMIN,
     WNI_CFG_ENABLE_RTSCTS_HTVHT_STAMAX,
     WNI_CFG_ENABLE_RTSCTS_HTVHT_STADEF},
    {WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_WLAN_LEN,
     CFG_CTL_VALID | CFG_CTL_RE | CFG_CTL_WE | CFG_CTL_INT | CFG_CTL_NTF_HAL,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_WLAN_LEN_STAMIN,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_WLAN_LEN_STAMAX,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_WLAN_LEN_STADEF},
    {WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_BT_LEN,
     CFG_CTL_VALID | CFG_CTL_RE | CFG_CTL_WE | CFG_CTL_INT | CFG_CTL_NTF_HAL,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_BT_LEN_STAMIN,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_BT_LEN_STAMAX,
     WNI_CFG_BTC_STATIC_OPP_WLAN_IDLE_BT_LEN_STADEF},
